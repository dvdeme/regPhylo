...
#'
#' @details Since the RGoogleMap API now requires a paying key (changed policy as of July 16 2018)
...
GeoCodeName = function(input = NULL, output = NULL, CorrTab = NULL, AutoCorrNZ = NULL) {
  ...
  # First clean the comma and other empty cells in the field 'Location'.
    ...
    if(is.null(AutoCorrNZ)){AutoCorrNZ = FALSE}
