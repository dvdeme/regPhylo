...
#' @description This function enables running several alignment softwares in parallel, including Muscle v3.8.31 (Edgar 2004),
...
#'
#' @param methods programs used to align the sequences. The function uses Mafft-FFTNS1
...
#'
#' @return This function returns the new alignments into the output folder.
...
#' # computer configuration, and are provided here as an example).
#'
#' Multi.Align(input = input, output = "multi.alignedTest", nthread = 3,
#' methods = c("mafftfftnsi", "muscle", "prank"),
...
Multi.Align = function(input = NULL, output = NULL, nthread = NULL, methods = NULL, Mafft.path = NULL,
  ...
  parallel::clusterExport(cl, varlist = c("output", "input", "nthread", "methods"), envir=environment())
